...
!curl  https://research.google.com/ava/download/ava_v2.1.zip -o ava_v2.1.zip
!unzip ava_v2.1.zip
...
df.columns = ['video_id','middle_frame_timestamp','person_box_x1','person_box_y1','person_box_x2','person_box_y2','action_id','person_id']
...
download_clip('zlVkeKC6Ha8','zlVkeKC6Ha8.mp4')

for video_id in video_list:
  download_clip(video_id,'{}.mp4'.format(video_id))

main('ava_train_v2.1.csv', 24)

!youtube-dl 'https://www.youtube.com/watch?v=zlVkeKC6Ha8'
